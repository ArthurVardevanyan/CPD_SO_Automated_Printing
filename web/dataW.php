...
$query = sprintf("SELECT `date_ordered`, COUNT(*) as order_count FROM `order_data`  WHERE `date_ordered` >=DATE(NOW()) - INTERVAL 7 DAY GROUP BY `date_ordered` ORDER BY `date_ordered`");
